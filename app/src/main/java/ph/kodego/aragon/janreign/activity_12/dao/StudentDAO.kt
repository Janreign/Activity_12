...
import ph.kodego.aragon.janreign.activity_12.model.Contact
import ph.kodego.aragon.janreign.activity_12.model.Student
import ph.kodego.aragon.janreign.activity_12.model.StudentContacts
...
interface StudentDAO {
    ...
    fun searchStudentByCourse(searchString: String) : ArrayList<Student>
...
// to call database
    ...
    override fun searchStudentByCourse(searchString: String) : ArrayList<Student> {
        ...
        try {
            cursor = db.query(DatabaseHandler.tableStudents,
                columns,
                "${DatabaseHandler.course} like '%${searchString}%'",
                null,
                null,
                null,
                DatabaseHandler.course
